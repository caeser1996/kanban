...
interface KanbanBoardProps {
  stageConfig: { id: string; title: string }[];
  boardId: string;
}
...
const NewKanbanBoard: React.FC<KanbanBoardProps> = ({ stageConfig, boardId }) => {
  ...
  useEffect(() => {
    const storedColumns = localStorage.getItem(`kanbanColumns_${boardId}`);
  ...
  useEffect(() => {
    localStorage.setItem(`kanbanColumns_${boardId}`, JSON.stringify(columns));
  }, [columns, boardId]);
