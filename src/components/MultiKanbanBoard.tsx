    ...
    <div className="h-screen flex flex-col bg-white">
      ...
      <div className="flex border-b bg-white">
        ...
        {stageConfig.map((stage) => (
          <div
            key={stage.id}
            className="flex-1 text-center p-2 font-semibold text-gray-600 border border-gray-300 rounded-md m-1"
          >
            {stage.title}
          </div>
        ))}
      ...
      <div className="flex-1 overflow-auto bg-white">
        {boardNames.map((boardName, boardIndex) => (
          <div key={boardIndex} className="mb-4">
            ...
            <div className="flex">
              {/* Work Item column */}
              <div className="w-1/6 flex flex-col items-center justify-start h-full p-4">
